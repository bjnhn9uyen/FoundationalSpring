...
public class RegistrationForm {
	...
	// Lombok generates getter/setter methods in alphabet order base on property’s name.
	// Therefore, if you name the password confirmation is ‘confirm’,
	// Lombok will sets value for the ‘confirm’ property first, then sets value for the ‘password’ property.
	// And if you try to compare value of the ‘confirm’ property and the ‘password’ property as above,
	// the value of the ‘password’ property will be null in this moment, because it hasn’t been set yet.
	// If you change ‘confirm’ to ‘pwConfirm’, the value of the ‘password’ property will have already set now,
