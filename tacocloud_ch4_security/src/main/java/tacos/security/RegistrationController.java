...
public class RegistrationController {
	...
	// this is PasswordEncoder bean we declared in SecurityConfig class
	...
	// RegistrationForm parameter is annotated with @ModelAttribute to indicate that it comes from the Model
	@PostMapping
