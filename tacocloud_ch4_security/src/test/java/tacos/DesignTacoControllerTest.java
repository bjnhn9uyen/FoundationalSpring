...
public class DesignTacoControllerTest {
	...
	public void setup() {
		...
		when(userRepository.findByUsername("testuser")).thenReturn(new User("testuser", "aA@00000",
								"Test User", "123 Street", "Someville", "CO", "12345", "1231231234"));
	}

	@Test
	@WithMockUser(username = "testuser", password = "aA@00000")
	...
	@Test
	@WithMockUser(username = "testuser", password = "aA@00000", authorities = "ROLE_USER")
